 ...
 */
package com.giuseppesorce.data.network;
...
import com.giuseppesorce.data.network.Util.GenericArrayTypeImpl;
import com.giuseppesorce.data.network.Util.ParameterizedTypeImpl;
import com.giuseppesorce.data.network.Util.WildcardTypeImpl;
import static com.giuseppesorce.data.network.Util.EMPTY_TYPE_ARRAY;
...
public final class Types {
  ...
  public static boolean equals(@Nullable Type a, @Nullable Type b) {
    if (a == b) {
      ...
      Type[] aTypeArguments =
          pa instanceof ParameterizedTypeImpl ? ((Util.ParameterizedTypeImpl) pa).typeArguments
              : pa.getActualTypeArguments();
      Type[] bTypeArguments =
          pb instanceof ParameterizedTypeImpl ? ((Util.ParameterizedTypeImpl) pb).typeArguments
